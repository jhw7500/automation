...
malformed, returns an exact-ID/digest untrusted artifact to the clean canonicalizer, and
machine-validates canonical one-line JSON changed anchors plus authenticated carryover identity.
